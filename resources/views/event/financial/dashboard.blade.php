...
<div class="grid grid-cols-1 md:grid-cols-3 gap-4">
    ...
    <div class="card p-5"><div class="text-xs uppercase text-gray-400 font-semibold"><i class="fa-solid fa-scale-balanced"></i> Remain balance</div><div class="text-xl font-semibold mt-1">{{ number_format($stats['remain']) }}</div></div>
    <div class="card p-5">
